...
local function get_light_node(player)
	...
	if light >= 14 then
		return "grandmaster:light_14"
	elseif light < 1 then
		return nil
	end
	return "grandmaster:light_"..light
end
...
local function find_light_pos(pos)
	...
	return minetest.find_node_near(pos, 1, {"air", "group:grandmaster"})
end
...
minetest.register_lbm({
	...
	name = "grandmaster:light_cleanup",
...
minetest.register_alias("grandmaster:light_faint", "grandmaster:light_4")
minetest.register_alias("grandmaster:light_dim", "grandmaster:light_8")
minetest.register_alias("grandmaster:light_mid", "grandmaster:light_12")
minetest.register_alias("grandmaster:light_full", "grandmaster:light_14")
